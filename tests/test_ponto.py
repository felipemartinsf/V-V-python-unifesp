...
def  test_trabalho_em_dia_de_folga():
    ...
    carga_diaria = timedelta(hours=8) #padrao clt
    # em dia de descanso (domingo/feriado) tudo que foi trabalhado eh extra,
    # entao precisamos avisar a funcao disso explicitamente (nao ha como
    # inferir "domingo" a partir de dois timedeltas)
    extras = calcular_horas_extras(horas, carga_diaria, is_dia_de_descanso=True)
